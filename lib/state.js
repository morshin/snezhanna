...
const DEFAULT_STATE = {
  ...
  // Snapshot of {id, project} taken when the evening checklist is sent —
  // checklist_tasks_done resolves positions against this, not a fresh
  // getTodayTasks() query, so a task added/completed/deleted after send
  // doesn't shift which task a later tick applies to.
  checklistTaskIds: null,
  ...
  // Onboarding
  onboarding_completed: false,   // true = первичная настройка завершена
  onboarding_step: null          // текущий шаг визарда или null
};
