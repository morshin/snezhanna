...
function isConfigured() {
  return isProxyConfigured() || isAppConfigured() || !!(process.env.GITHUB_ISSUES_TOKEN || process.env.GITHUB_TOKEN);
}
...
async function createIssue({ title, body, labels, imageBase64, imageMimeType }) {
  ...
  // Proxy to main instance if configured (tenant instances)
