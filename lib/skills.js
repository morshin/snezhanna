...
const GROUPS = [
  ...
  },
  {
    ...
    label: '**GitHub**',
    text: 'Активные milestones с приближающимися или просроченными дедлайнами; создание issues (баги, пожелания).',
  },
  {
    sentinel: ['web_search'],
    label: '**Веб-поиск**',
  ...
  },
  {
    ...
    label: '**Настройки**',
    text: 'Изменение имени, стиля общения, персонажа бота; режим тишины / отпуска; per-skill инструкции (get_skill_context / update_skill_context); обновление бота (update_bot).',
  },
  {
...
const ALWAYS_ON = [
  ...
  {
    text: '**Утренний брифинг** — ежедневный дайджест: календарь, почта, задачи, GitHub, погода, Strava. Если недавно предлагался брифинг и ответ пользователя неоднозначен — используй start_briefing, если это согласие.',
