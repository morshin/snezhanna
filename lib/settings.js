...
const BOT_GENDER_LABELS = {
  female:  'женский — говори о себе в женском роде: «я сделала», «обновила», «написала», «не поняла»',
  male:    'мужской — говори о себе в мужском роде: «я сделал», «обновил», «написал», «не понял»',
  neutral: 'нейтральный — избегай родовых форм для самоупоминаний: «сделано», «готово», «обновлено»',
};
...
function getSettingsBlock() {
  ...
  const botGender = get('bot_gender');
  ...
  if (botGender) block += `\n- Гендер ассистента: ${BOT_GENDER_LABELS[botGender] || botGender}`;
