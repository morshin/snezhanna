...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Создать issue (баг-репорт или пожелание) в GitHub-репозитории Снежанны. Используй когда пользователь хочет сообщить о проблеме, предложить улучшение или задать вопрос разработчику. Если пользователь отправил скриншот вместе с запросом — он прикрепится автоматически.',
    input_schema: {
      type: 'object',
      properties: {
