...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Update user preferences and settings. Use when Vova asks to change how Snezhanna behaves, communicates, or schedules things — e.g. "называй меня Вов", "отвечай покороче", "перенеси брифинг на 9:00", "включи Strava", "выключи GitHub".',
    input_schema: {
      type: 'object',
      properties: {
...
function setContext(appState, saveStateFn, rescheduleBriefingFn) {
  _appState = appState;
